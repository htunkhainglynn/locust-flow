...
class TestRetryOn(unittest.TestCase):
    ...
    def test_execute_http_step_with_retry_and_action(self, mock_find_step, mock_make_request):
        ...
        mock_make_request.side_effect = [first_response, login_response, second_response]
    ...
    @patch('framework.flow_executor.FlowExecutor._make_request')
    @patch('framework.flow_executor.FlowExecutor._find_step_by_name')
    def test_execute_http_step_max_retries_reached(self, mock_find_step, mock_make_request):
